...
<?php
    ...
    $query="SELECT `M_ID`, `CAT_ID`, `NAME`, `DESCRIPTION`, `PRICE` FROM `machines` WHERE M_ID ='$MID'";
...
?>
    ...
    <form action="code1.php" method="POST">
        ...
        <a href="admin_machines.php" class="btn btn-danger">CANCEL</a>
        <input type="hidden" name="edit_id" value="<?php echo $MID?>">
